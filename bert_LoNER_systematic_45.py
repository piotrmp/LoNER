...
from data_processing.category_lenghts import PTC_average_lenghts_dict
...
k_lengths = list(PTC_average_lenghts_dict.values())
sequence_length = 200
batch_size = 4
num_epochs = 50
variant = 45
...
bert_body = Models.adaptive_conv.BertPTC_slaner(float_type=tf.float32, num_labels=15, max_seq_length=sequence_length,
                           hub_path=bert_model_path, kernels=k_lengths,arch_params=params)
